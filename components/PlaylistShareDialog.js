...
const PlaylistShareDialog = ({
    ...
    useEffect(() => {
        if (metaCurrentUrl && metaTitle && metaDescription && metaImage) {
            if (url == undefined || contentTitle == undefined || content?.image == undefined || content?.header_desc == undefined) {
                return;
            }
            ...
            if (!play) {
                if (isOpen) {
                    ...
                    metaDescription(content?.header_desc);
                }
            }
            else {
                if (isOpen) {
                        ...
                        <DialogContentText id="alert-dialog-slide-description">
                            <div className=" text-white justify-center text-center flex-column">
                                ...
                                <div className="text-gray-400 text-sm font-sans">
                                    {content?.more_info?.primary_artists_label ? content?.more_info?.primary_artists_label : truncate(content?.header_desc, 80)}
